...
Push result: `git push origin main` succeeded. After the final metadata push, `git status -sb` should report `## main...origin/main`; the checkpoint feature commit recorded above is included on `origin/main`.
```
