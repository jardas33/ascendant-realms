# v0.117 Godot Salto Spike

This is the first automated Godot desktop benchmark spike scaffold for the engine-neutral Salto fixture. It is a small, placeholder-only project for validating AI-first/editor-optional workflow, not a port and not a final engine choice.

## Boundaries

- No browser runtime deletion or replacement.
- No gameplay, AI, pathing, balance, reward, save, stable-ID, localStorage, art-import, runtime asset path, multiplayer, PvP, co-op, or engine-choice change.
...
Generated local evidence is written under `artifacts/desktop-spikes/godot-salto/latest/`. If Godot or export templates are missing, runtime benchmark/export/package reports must say `BLOCKED_PENDING_LOCAL_GODOT_SETUP`.
