...
func configure_barrosan_playable_runtime_skin(options: Dictionary) -> void:
	...
	barrosan_runtime_checkpoint = "v0.253" if barrosan_requested_checkpoint in ["v0.254", "v0.255", "v0.256", "v0.257", "v0.258", "v0.259", "v0.261", "v0.262", "v0.263", "v0.264", "v0.265", "v0.266", "v0.267", "v0.268", "v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] else barrosan_requested_checkpoint
...
func _sync_hud() -> void:
	...
	if barrosan_requested_checkpoint in ["v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and (_v0269_is_review_mode(barrosan_runtime_review_mode) or _v0270_is_review_mode(barrosan_runtime_review_mode) or _v0271_is_review_mode(barrosan_runtime_review_mode) or _v0272_is_review_mode(barrosan_runtime_review_mode) or _v0273_is_review_mode(barrosan_runtime_review_mode) or _v0274_is_review_mode(barrosan_runtime_review_mode) or _v0275_is_review_mode(barrosan_runtime_review_mode) or _v0276_is_review_mode(barrosan_runtime_review_mode) or _v0277_is_review_mode(barrosan_runtime_review_mode)):
...
func set_barrosan_runtime_review_mode(mode: String) -> void:
	...
	if barrosan_requested_checkpoint in ["v0.276", "v0.277"] and _v0276_is_review_mode(mode):
		_v0276_apply_review_mode(mode)
	if barrosan_requested_checkpoint in ["v0.275", "v0.276", "v0.277"] and _v0275_is_review_mode(mode):
		_v0275_apply_review_mode(mode)
	if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and _v0274_is_review_mode(mode):
	...
	if barrosan_requested_checkpoint in ["v0.261", "v0.262", "v0.263", "v0.264", "v0.265", "v0.266", "v0.267", "v0.268", "v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and _v0261_is_review_mode(mode):
	...
	elif barrosan_requested_checkpoint in ["v0.276", "v0.277"] and _v0276_is_review_mode(mode):
		_v0261_apply_resolved_ui()
		_v0269_apply_first_contact_ui()
		_v0276_apply_manual_engage_ui()
		_v0276_record_manual_engage_proof(mode)
	elif barrosan_requested_checkpoint in ["v0.275", "v0.276", "v0.277"] and _v0275_is_review_mode(mode):
		_v0261_apply_resolved_ui()
		_v0269_apply_first_contact_ui()
		_v0275_record_label_arbitration_proof(mode)
	elif barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and _v0274_is_review_mode(mode):
		_v0261_apply_resolved_ui()
		_v0269_apply_first_contact_ui()
...
func _v0269_contact_lines(preview: Dictionary, contact_state: String, integrity: float) -> Array:
	...
	match str(preview.get("advisoryState", "precomplete")):
		...
		"current_detection":
			...
			if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
				...
				if barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(barrosan_playtest.get("v0273PostContactHoldState", "not braced")) in ["brace available", "bracing bridge", "bridge held"]:
					lines.append("Bridge held by Militia")
					lines.append("Pressure contained at 90/100")
				if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and str(barrosan_playtest.get("v0274EngagementStanceState", "no engagement stance")) in ["engagement stance available", "engagement stance active", "engagement stance retained after reguard"]:
...
func _v0269_update_first_contact_state() -> Dictionary:
	...
	if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(preview.get("advisoryState", "")) == "current_detection" and not applied:
	...
	if applied:
		...
		if str(preview.get("advisoryState", "")) == "last_seen_memory":
			...
			if barrosan_requested_checkpoint in ["v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and feedback_phase in ["resolved", "ended"]:
	...
	contact["v0274AddsEngagementStanceReadabilityOnly"] = barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"]
	...
	contact["guardRequiredForContact"] = barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]
	contact["clearedGuardBlocksContact"] = barrosan_requested_checkpoint in ["v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and guard_state == "cleared" and not bool(contact.get("contactEligible", true))
	contact["clearGuardDoesNotResetIntegrity"] = barrosan_requested_checkpoint in ["v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and (not applied or integrity == V0269_PRESSURE_INTEGRITY_AFTER_CONTACT)
	contact["clearGuardDoesNotResetCooldown"] = barrosan_requested_checkpoint in ["v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and (feedback_phase != "resolved" or bool(contact.get("cooldownLocked", false)))
	...
	if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
		if guard_state == "pending":
			...
			_set_minimap_marker_visible("v0271_minimap_guard_pending", false)
			_set_minimap_marker_visible("v0271_minimap_guard_holding", false)
	if barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
		if brace_state in ["bracing bridge", "bridge held"] and guard_state != "cleared" and contact_state == "resolved":
			...
			_set_minimap_marker_visible("v0273_minimap_bridge_held", false)
	if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"]:
	...
	if bool(contact.get("contactApplied", false)) and bool(contact.get("currentDetection", false)) and not (barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and contact_state == "resolved"):
...
func _v0269_apply_first_contact_ui() -> void:
	...
	if bool(contact.get("relayVisible", false)):
		...
		if hud_objective_strip_label != null:
			if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state == "engagement stance cleared":
				hud_objective_strip_label.text = "Guard cleared after contact -- engagement ended"
			elif barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state in ["engagement stance active", "engagement stance retained after reguard"]:
				hud_objective_strip_label.text = "Engagement stance -- contained, no attack"
			elif barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state == "engagement stance available":
			...
			elif barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and guard_state == "pending":
				hud_objective_strip_label.text = "Guard order pending -- move Militia to east bridge"
			elif barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and guard_state == "holding east bridge" and contact_state in ["awaiting pressure", "armed"]:
		...
		if hud_onboarding_label != null:
			if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state in ["engagement stance active", "engagement stance retained after reguard"]:
			...
			elif barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state == "engagement stance cleared":
		...
		if hud_onboarding_label != null:
			...
			hud_onboarding_label.visible = true
		if hud_context_label != null:
			hud_context_label.text = "Engagement stance: contained | Bridge held | Pressure contained: 90/100 | No auto-move | No ranged attack | No projectile | No attack committed" if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state in ["engagement stance available", "engagement stance active", "engagement stance retained after reguard"] else ("Guard cleared -- engagement stance ended | Pressure remains 90/100 | Cooldown locked" if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state == "engagement stance cleared" else ("Brace Bridge state: %s | No auto-move | No ranged attack | No projectile" % hold_state if barrosan_requested_checkpoint == "v0.273" else ("Guard order: %s | No auto-move | No ranged attack | No projectile" % guard_state if barrosan_requested_checkpoint in ["v0.271", "v0.272"] else "Defender position: holding east bridge | No ranged attack | No projectile")))
		if hud_objective_label != null:
			if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"] and engagement_state in ["engagement stance active", "engagement stance retained after reguard"]:
		...
		if hud_work_button != null and barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
...
func _sync_v0269_barrosan_militia_first_contact_visuals() -> void:
	if visual_root == null or not (barrosan_requested_checkpoint in ["v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]):
		return
	...
	if barrosan_requested_checkpoint in ["v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
	...
	if contact_marker != null:
		contact_marker.visible = str(contact.get("contactState", "")) in ["engaged", "resolved"] and bool(contact.get("currentDetection", false)) and not (barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(contact.get("contactState", "")) == "resolved")
	...
	if barrosan_requested_checkpoint in ["v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
		...
		resolved_label.visible = str(contact.get("contactState", "")) == "resolved" and bool(contact.get("currentDetection", false)) and not (barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(contact.get("postContactHoldState", "")) in ["bracing bridge", "bridge held", "brace cleared"])
	if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
	...
	if barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"]:
		...
		stance_label.visible = stance_visible and (barrosan_runtime_review_mode == "v0274_label_declutter_engagement_stance" or barrosan_requested_checkpoint in ["v0.275", "v0.276", "v0.277"])
	if barrosan_requested_checkpoint in ["v0.275", "v0.276", "v0.277"]:
...
func _add_v0269_contact_minimap_ping() -> void:
	if minimap_panel == null or not (barrosan_requested_checkpoint in ["v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]):
		return
...
func _add_v0271_guard_minimap_marker(state: String) -> void:
	if minimap_panel == null or not (barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]):
		return
...
func _add_v0273_bridge_held_minimap_marker() -> void:
	if minimap_panel == null or not (barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]):
		return
...
func _add_v0274_engagement_minimap_marker() -> void:
	if minimap_panel == null or not (barrosan_requested_checkpoint in ["v0.274", "v0.275", "v0.276", "v0.277"]):
		return
	...
	if barrosan_runtime_skin_enabled:
		...
		if barrosan_requested_checkpoint == "v0.268":
			...
			if str(intercept.get("interceptPreviewState", "")) == "intercept ready":
				_add_v0268_intercept_ready_minimap_marker()
		if barrosan_requested_checkpoint in ["v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
			...
			if str(contact.get("interceptPreviewState", "")) == "intercept ready":
				_add_v0268_intercept_ready_minimap_marker()
			if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(contact.get("guardOrderState", "")) == "pending":
				_add_v0271_guard_minimap_marker("pending")
			if barrosan_requested_checkpoint in ["v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(contact.get("guardOrderState", "")) in ["holding east bridge", "resolved after contact"]:
				_add_v0271_guard_minimap_marker("holding")
			if bool(contact.get("contactApplied", false)) and bool(contact.get("currentDetection", false)) and not (barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] and str(contact.get("contactState", "")) == "resolved"):
				_add_v0269_contact_minimap_ping()
			if barrosan_requested_checkpoint in ["v0.273", "v0.274", "v0.275", "v0.276", "v0.277"]:
...
func get_spike_status() -> Dictionary:
	...
	status["barrosanPlayableRuntimeSkin"] = {
		...
		"watchpostFoundation": _v0261_watchpost_status() if barrosan_requested_checkpoint in ["v0.261", "v0.262", "v0.263", "v0.264", "v0.265", "v0.266", "v0.267", "v0.268", "v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] else {},
		"watchpostAwarenessLayer": _v0262_awareness_status() if barrosan_requested_checkpoint == "v0.262" else {},
		"watchpostIntelMemory": _v0263_intel_memory_status() if barrosan_requested_checkpoint in ["v0.263", "v0.264", "v0.265", "v0.266", "v0.267", "v0.268", "v0.269", "v0.270", "v0.271", "v0.272", "v0.273", "v0.274", "v0.275", "v0.276", "v0.277"] else {},
