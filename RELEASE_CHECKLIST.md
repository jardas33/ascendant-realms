...
| Visual-intake change | Routine gate, especially `npm run validate:art-intake` and `npm run art:review:validate` | Add `npm run visual:qa` only when screenshot comparison docs or candidate-review evidence changes. |
