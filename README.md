...
Current v0.14 work packages the browser prototype for private human playtesting: playtest-safe production build output, ignored package folders under `artifacts/playtest/`, tester-facing README and feedback files, build metadata, local server launchers, and package verification. No runtime gameplay, gameplay numbers, maps, factions, units, art/assets, save format, combat systems, campaign progression, or hosted release plumbing was changed.
