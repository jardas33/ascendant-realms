...
Current v0.12 work is a core game-feel and battle-readability pass on that stable foundation: clearer command acknowledgement, stronger selected-order hierarchy, actionable objective and pressure copy, and more useful victory/defeat guidance, with no new art, maps, factions, units, save migration, broad AI rewrite, or hosted release plumbing.
