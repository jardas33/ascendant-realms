...
Current v0.12.1 work is a human-paced core-feel playtest review on that stable foundation: v0.12's command, selection, objective, pressure, and results readability improvements have been slow-play reviewed, Cinderfen player-facing battle names now align as Cinderfen Crossing and Cinderfen Watch, Cinder Shrine objective copy is clearer, and skirmish defeat guidance no longer points at campaign-only support. No new art, maps, factions, units, save migration, broad AI rewrite, or hosted release plumbing was added.
