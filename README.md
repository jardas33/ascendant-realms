...
Current v0.12.6 work prepares the existing v0.12.x prototype for real manual tester distribution: short tester quick-start, route assignment, copy-paste feedback packet, coordinator guide, storage plan, and ready-to-send tester message. No runtime code, gameplay numbers, maps, factions, units, art/assets, save format, combat systems, campaign progression, or hosted release plumbing was changed.
