import type { BattleMapDefinition, BattleSecondaryObjectiveType, Position } from "../core/GameTypes";
...
export function completeBattleSecondaryObjective(options: CompleteSecondaryObjectiveOptions): void {
