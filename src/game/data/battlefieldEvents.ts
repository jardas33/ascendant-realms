...
export const BATTLEFIELD_EVENTS: BattlefieldEventDefinition[] = [
  ...
  },
  {
    ...
    name: "Aether Surge",
    shortLabel: "Aether",
    description: "A short mission-local aether opportunity favors hero ability use.",
    ...
    afterActionSummary: "Aether timing encouraged readable hero ability pressure.",
    eligibleDoctrineIds: ["hunter", "warband"],
