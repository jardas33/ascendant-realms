...
import { CINDERFEN_WATCHPOST_MAP } from "./cinderfenWatchpost";
...
export { CINDERFEN_WATCHPOST_MAP } from "./cinderfenWatchpost";
...
export const MAPS: BattleMapDefinition[] = [
  ...
  BROKEN_FORD_MAP,
  ASHEN_OUTPOST_MAP,
  CINDERFEN_CAUSEWAY_MAP,
  CINDERFEN_WATCHPOST_MAP
];
