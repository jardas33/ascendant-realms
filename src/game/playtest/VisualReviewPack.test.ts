...
describe("Visual review pack generator", () => {
  it("generates deterministic review output from the visual QA index and manifest", async () => {
    ...
    expect(first.screenshotCount).toBe(15);
    expect(first.contactSheetCount).toBe(10);
  });
  ...
  it("includes all required screen groups, target viewports, and contact sheets", async () => {
    ...
    [
      ...
      "contact-sheets/trusted-benchmark.html",
...
async function createFixture(
  ...
  const captures = [
    ...
    ["v0109-trusted-diagnostics-expanded-1366.png", "v0.109 trusted diagnostics expanded", "1366x768 laptop", "Trusted benchmark diagnostics."],
