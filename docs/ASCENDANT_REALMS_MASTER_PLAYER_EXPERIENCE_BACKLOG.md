...
|---|---|---|---|---|---|---|---|---|---|
| P0-NAV-001 | Navigation/pathfinding reliability | Focused v0.436-R1/R1A/R1B/R1F proof accepted; R1G natural-match observation reached `BLOCKED_R1G_PLAYER_ASSAULT_FORCE_ELIMINATED`; no new navigation repair authorized | Workers and armies can fail long commands | v0.436-R1 source repair; v0.436-R1A/R1B proof pack; v0.436-R1F physics-frame truth pack | Navigation map lifecycle, projection, retries, target churn; timer-vs-physics sampling contract repaired | Natural conquest capture remains separate | Long worker, military, pursuit, invalid-target, and isolated boundary cases complete with bounded telemetry; continue monitoring in natural conquest | v0.436-R1F / follow-up | Physics-frame acceptance restored; R1G recorded a truthful assault-force-eliminated blocker |
| P0-RESULT-001 | Natural conquest/result/replay proof | Open; R1G truthful capture stopped at `BLOCKED_R1G_PLAYER_ASSAULT_FORCE_ELIMINATED` before natural conquest | Players need trustworthy match completion and replay flow | v0.436 conquest capture remains separate | Requires accepted navigation behavior first | v0.436-R1A acceptance | Real gameplay-scale victory, result freeze, Continue, and Play Again evidence | v0.437 candidate | No |
| P0-GAME-001 | Other game-breaking defects found during real play | Watch | Can block ordinary play | Future gameplay-scale audit | To be determined from real runs | Broad audit | Reproducible issue record and bounded repair | Future audit | No |
