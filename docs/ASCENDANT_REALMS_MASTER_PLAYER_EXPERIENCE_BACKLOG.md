...
|---|---|---|---|---|---|---|---|---|---|
| P0-NAV-001 | Navigation/pathfinding reliability | Focused v0.436-R1/R1A/R1B proof accepted; continue monitoring during separate natural conquest capture | Workers and armies can fail long commands | v0.436-R1 source repair; v0.436-R1A/R1B proof pack | Navigation map lifecycle, projection, retries, target churn | Natural conquest capture remains separate | Long worker, military, pursuit, invalid-target, and isolated boundary cases complete with bounded telemetry; continue monitoring in natural conquest | v0.436-R1B / follow-up | Focused proof only |
