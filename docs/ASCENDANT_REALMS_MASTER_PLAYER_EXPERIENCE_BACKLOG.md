...
|---|---|---|---|---|---|---|---|---|---|
| P0-NAV-001 | Navigation/pathfinding reliability | Open; v0.436-R1 repair landed, behavioral proof incomplete | Workers and armies can fail long commands | v0.436-R1 source repair; v0.436-R1A proof pack | Navigation map lifecycle, projection, retries, target churn | Real headed multi-case proof | Long worker, military, pursuit, invalid-target, and boundary cases complete with bounded telemetry | v0.436-R1A / follow-up | No |
