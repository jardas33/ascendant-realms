...
- Defender Readiness Bridge status: IN_PROGRESS.
- Calm no-intel status: PASS.
- Current none status: PASS.
- Current training status: PASS.
- Current ready status: PASS.
- Memory none status: PASS.
- Memory training status: PASS.
- Memory ready status: PASS.
- Outside-zone false-positive status: PASS.
- Memory-not-current status: PASS.
- No precomplete readiness status: PASS.
- Barracks advisory-line status: PASS.
- Barracks training path status: PASS.
- Current/memory minimap status: PASS.
- World label clutter status: PASS.
- Forbidden combination status: PASS.
- Passive/readiness-only status: PASS.
...
- Runtime capture count: 23.
- PNG files inspected for black-frame rejection: 24.
