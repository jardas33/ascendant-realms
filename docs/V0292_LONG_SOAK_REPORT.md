...
After manual matrix run `26490433401` found one stale duplicate movement-summary assertion in the older minimap/fog/move hosted test, the exact failed test was repeated:
...
The full hosted deep-battle lane was repeated afterward:
