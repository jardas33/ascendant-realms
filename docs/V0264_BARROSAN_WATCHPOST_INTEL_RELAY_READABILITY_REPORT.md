...
- INTEL RELAY READABILITY status: PASS.
...
- Required screenshots: 24.
- Runtime capture count: 20.
- PNG files inspected for black-frame rejection: 21.
- Minimum PNG bytes: 127739.
- Minimum sampled unique colors: 1865.
- Minimum mean brightness: 57.074.
- Minimum brightness standard deviation: 16.381.
