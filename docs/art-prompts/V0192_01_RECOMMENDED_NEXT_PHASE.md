# v0.192 Prompt: Bridge-Riverbank Material Opt-In Integration

Execute this bounded goal exactly as written.

# v0.192 - Bridge-riverbank material opt-in integration

## Run Condition

Run only after v0.191 passed, was committed, pushed, clean, synced, and remote-green.

Expected prior message:

`Checkpoint v0.191 post-shell-freeze next-phase scorecard and v0.192 preparation only`
...
Preserve all earlier launchers.
...
Do not perform broad cleanup, archive moves, or evidence deletion.
...
`Checkpoint v0.192 bridge-riverbank material opt-in integration`

Push safely and stop for human review.

Return selected hash, fallback proof, visual decision, performance result, cleanup state, boundaries, commit, CI, and confirmation v0.193 was not started.
