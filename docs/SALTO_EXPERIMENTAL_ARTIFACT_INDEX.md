...
Status: `ACTIVE_V0202_RETENTION_INDEX`
...
| Barrosan wet-granite bridge-riverbank material | active isolated shell-v2 mesh-compositor opt-in for bridge abutments and riverbank retaining edges only; not enabled by default | `artifacts/desktop-spikes/godot-salto/v0189/local-bridge-riverbank-material-slot/barrosan_wet_granite_bridge_riverbank_material_v0189_1024.png` | `638ce153d7a3d39db729dfa13ba05f3fb05c437c2802ab91b5cd248bd2036753` |
| Barrosan structure-finish material | selected private-comparator-only source and derivative; not integrated into player slice | `artifacts/desktop-spikes/godot-salto/v0202/local-structure-finish-material-slot/barrosan_structure_finish_material_v0202_1024.png` | `94d4975f9e6f13453103439135da930b74d1d66b56d2b10e43219de408f508ef` |
...
Retain all tracked fallback `.png` and `.contract.json` files under `desktop-spikes/godot-salto/comparators/runtime_art_pipeline/fallback/` for Worker, Barracks, Militia, Aster, Ashen Raider, the v0.175 private Barrosan foothold ground-material comparator, the v0.180 private Barrosan foothold road-material comparator, the v0.189 private Barrosan wet-granite bridge-riverbank material comparator, and the v0.202 private Barrosan structure-finish material comparator.
...
- `artifacts/desktop-spikes/godot-salto/v0194/before-v0193-authoritative/`
- `artifacts/desktop-spikes/godot-salto/v0194/validation/`
- `artifacts/desktop-spikes/godot-salto/v0194/capture/`
- `artifacts/desktop-spikes/godot-salto/v0194/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0194/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0194/artifact-retention/`
...
- `artifacts/desktop-spikes/godot-salto/v0195/before-v0194-authoritative/`
- `artifacts/desktop-spikes/godot-salto/v0195/validation/`
- `artifacts/desktop-spikes/godot-salto/v0195/capture/`
- `artifacts/desktop-spikes/godot-salto/v0195/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0195/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0195/cleanup-dry-run/`
- `artifacts/desktop-spikes/godot-salto/v0195/cleanup-safe-only/`
- `artifacts/desktop-spikes/godot-salto/v0195/artifact-retention-post-cleanup/`
...
- `artifacts/desktop-spikes/godot-salto/v0197/validation/`
- `artifacts/desktop-spikes/godot-salto/v0197/capture/`
- `artifacts/desktop-spikes/godot-salto/v0197/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0197/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0197/cleanup-dry-run/`
- `artifacts/desktop-spikes/godot-salto/v0197/cleanup-safe-only/`
- `artifacts/desktop-spikes/godot-salto/v0197/artifact-retention-post-cleanup/`
...
- `artifacts/desktop-spikes/godot-salto/v0198/validation/`
- `artifacts/desktop-spikes/godot-salto/v0198/capture/`
- `artifacts/desktop-spikes/godot-salto/v0198/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0198/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0198/cleanup-dry-run/`
- `artifacts/desktop-spikes/godot-salto/v0198/cleanup-safe-only/`
- `artifacts/desktop-spikes/godot-salto/v0198/artifact-retention-post-cleanup/`
...
- `artifacts/desktop-spikes/godot-salto/v0199/validation/`
- `artifacts/desktop-spikes/godot-salto/v0199/capture/`
- `artifacts/desktop-spikes/godot-salto/v0199/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0199/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0199/cleanup-dry-run/`
- `artifacts/desktop-spikes/godot-salto/v0199/cleanup-safe-only/`
- `artifacts/desktop-spikes/godot-salto/v0199/artifact-retention-post-cleanup/`
...
- `artifacts/desktop-spikes/godot-salto/v0200/validation/`
- `artifacts/desktop-spikes/godot-salto/v0200/capture/`
- `artifacts/desktop-spikes/godot-salto/v0200/benchmark/`
- `artifacts/desktop-spikes/godot-salto/v0200/boundary/`
- `artifacts/desktop-spikes/godot-salto/v0200/cleanup-dry-run/`
- `artifacts/desktop-spikes/godot-salto/v0200/cleanup-safe-only/`
- `artifacts/desktop-spikes/godot-salto/v0200/artifact-retention-post-cleanup/`
...
Character-slot expansion is frozen after the selected Worker, Barracks material, Militia, Aster, and Ashen Raider opt-in slots. v0.202 adds one private-comparator-only structure-finish material source, selected derivative, tracked fallback, and comparator path. It does not integrate the material into the normal player slice, does not add a runtime art slot, and does not begin v0.203. The existing Barrosan foothold ground-material opt-in slot, Barrosan foothold road-material opt-in slot, and scoped v0.198 wet-granite bridge-riverbank shell-v2 mesh opt-in remain behind their prior explicit launchers only. No water shader pipeline is added, the default launcher remains procedural, browser runtime remains untouched, and the legacy shell is preserved as comparator/fallback.
...
Unknown files are preserved and block cleanup. v0.202 adds selected private-comparator structure-finish evidence to the protected set. Broad deletion or archive moves are not authorized by this index.
