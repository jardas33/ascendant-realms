...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0173.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoEnvironmentFoundationWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
