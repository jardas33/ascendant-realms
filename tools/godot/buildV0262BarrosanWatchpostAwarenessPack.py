...
draw.text((140, 145), "v0.262 PREFLIGHT - BARROSAN WATCHPOST AWARENESS", fill="#e8d99d")
draw.text((140, 225), "Base HEAD / origin/main:", fill="#9ecfc5")
draw.text((140, 275), "74d36f0de995852db1e5666fc18ed75aa2656fe9", fill="#ffffff")
draw.text((140, 365), "Baseline exact-SHA Actions run:", fill="#9ecfc5")
draw.text((140, 415), "28337172806 - completed / success", fill="#9fe2a3")
draw.text((140, 510), "Scope:", fill="#9ecfc5")
draw.text((140, 560), "Passive Watchpost awareness only: no attack, projectiles, combat, economy, waves, Blender, GLB, or default-runtime changes.", fill="#ffffff")
draw.text((140, 650), "Cost/HP unchanged: 100 Crowns / 30 Stone / 10 Iron / 0 Aether; HP 120/120.", fill="#d7c98f")
preflight.save(root / "01_v0262_preflight_head_ci_resolution.png")
...
capture_paths = [root / "02_v0262_default_runtime_unchanged_visible.png"] + [
...
(root / "v0262-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.262 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
draw.text((100, 590), "Default runtime and opt-in Watchpost awareness runtime were both inspected.", fill="#d7c98f")
report.save(root / "18_v0262_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0262_preflight_head_ci_resolution.png"] + capture_paths + [root / "18_v0262_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "17_v0262_contact_sheet_visible.png")
