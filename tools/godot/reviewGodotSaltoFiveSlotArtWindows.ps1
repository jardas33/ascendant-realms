...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0170.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoFiveSlotArtExperimentWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
