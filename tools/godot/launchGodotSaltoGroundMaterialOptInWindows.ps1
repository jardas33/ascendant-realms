...
$ArgumentList = @(
  "--player-slice",
  "--experimental-review-mode-label=Experimental opt-in art: 5 slots + Barrosan foothold ground",
...
if ($Wait) {
  ...
  if ($GodotExitCode -ne 0) {
    throw "Packaged Godot ground-material opt-in review exited with code $GodotExitCode."
  }
  return
}
