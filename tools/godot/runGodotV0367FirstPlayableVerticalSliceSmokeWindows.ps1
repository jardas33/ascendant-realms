...
$ArtifactRoot = Join-Path $RepoRoot "artifacts\runtime\v0367"
New-Item -ItemType Directory -Force -Path $ArtifactRoot | Out-Null
$ArtifactArg = $ArtifactRoot.Replace("\", "/")
& $GodotExe --headless --path desktop-spikes/godot-salto -- "--v0367-smoke" "--artifact-root=$ArtifactArg"
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
node tools/godot/saltoV0367FirstPlayableVerticalSliceTool.mjs smoke
