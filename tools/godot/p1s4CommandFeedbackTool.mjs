...
function expectedNames(width) {
  return width === 1920
    ? ["01_MOVE_ACK", "02_ATTACK_ACK", "03_GATHER_ACK", "04_BUILD_CONTINUE_ACK", "05_RALLY_ACK", "06_ATTACK_MOVE_ACK", "07_BUILD_VALID_CURSOR_CONTEXT", "08_BUILD_INVALID_CURSOR_CONTEXT", "09_UI_HOVER_SAFE"]
