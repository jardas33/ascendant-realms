...
function validate() {
  ...
  const allowed = new Set(["package.json", "production/ascendant-realms-godot/scripts/ui/hud.gd", "production/ascendant-realms-godot/tests/p1r3_minimap_terrain.gd", "tools/godot/p1r3MinimapTerrainTool.mjs"]);
