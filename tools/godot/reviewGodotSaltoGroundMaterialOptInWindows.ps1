...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0178.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoGroundMaterialOptInWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
