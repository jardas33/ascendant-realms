...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0186.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoStructureShellHardeningWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
