...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0196.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoShellV2MeshCompositorWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
