...
node tools/godot/saltoBattlefieldMaterialValueIntegrationTool.mjs benchmark "--artifact-root=$($ArtifactRoot.Replace('\','/'))"
if ($LASTEXITCODE -ne 0) { throw "v0.231 benchmark failed." }
Write-Output "PASS_V0231_BATTLEFIELD_MATERIAL_VALUE_INTEGRATION_BENCHMARK_READY"
