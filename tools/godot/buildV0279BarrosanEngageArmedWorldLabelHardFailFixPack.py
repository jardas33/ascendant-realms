...
draw.text((140, 145), "v0.279 PREFLIGHT - BARROSAN Engage Armed World-Label Hard Fail Fix", fill="#e8d99d")
draw.text((140, 225), "Base HEAD:", fill="#9ecfc5")
draw.text((140, 275), "4b63949d9931e2a9d72bf9fdecc46da8461a7c8c", fill="#ffffff")
draw.text((140, 365), "Baseline exact-SHA Actions run:", fill="#9ecfc5")
draw.text((140, 415), "28625534888 - success", fill="#9fe2a3")
...
preflight.save(root / "01_v0279_preflight_head_ci_resolution.png")

capture_paths = [root / "02_v0279_default_runtime_unchanged_visible.png"] + [
...
(root / "v0279-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.279 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
draw.text((100, 590), "Default runtime and opt-in v0.279 readability runtime were both inspected.", fill="#d7c98f")
report.save(root / "18_v0279_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0279_preflight_head_ci_resolution.png"] + capture_paths + [root / "18_v0279_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "17_v0279_contact_sheet_visible.png")
