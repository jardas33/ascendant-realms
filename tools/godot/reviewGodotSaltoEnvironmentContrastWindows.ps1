...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0179.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoEnvironmentContrastWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
