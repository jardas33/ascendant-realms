...
def main() -> None:
    ...
    (PACK / "runtime-method-assessment.md").write_text("H3 ANIMATION ENGINEERING METHOD: UNPROVEN\nEVIDENCE INVALID — H3 DIRECTIONAL ANIMATION PIPELINE REMAINS UNPROVEN\nCURRENT ANIMATED CHARACTER ASSETS: MICRO-PILOT ONLY — NOT FINAL PLAYER-FACING ART\nDEFAULT-RUNTIME INTEGRATION: NOT APPROVED\n", encoding="utf-8")
    ...
    (PACK / "final-decision.md").write_text("EVIDENCE INVALID — H3 DIRECTIONAL ANIMATION PIPELINE REMAINS UNPROVEN\n\nThe per-event runtime evidence reported requested=true with enabled=false for 46 of 48 records. v0.315 recovers the lifecycle seam and re-captures live evidence.\n", encoding="utf-8")
