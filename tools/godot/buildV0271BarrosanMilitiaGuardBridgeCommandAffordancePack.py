...
draw.text((140, 145), "v0.271 PREFLIGHT - BARROSAN Militia Guard Bridge Command", fill="#e8d99d")
draw.text((140, 225), "Base HEAD / origin/main:", fill="#9ecfc5")
draw.text((140, 275), "64384021d8ca06931d760fbd14dd422469e63ef8", fill="#ffffff")
draw.text((140, 365), "Baseline exact-SHA Actions run:", fill="#9ecfc5")
draw.text((140, 415), "28478695860 - success", fill="#9fe2a3")
draw.text((140, 510), "Scope:", fill="#9ecfc5")
draw.text((140, 560), "Command/readability/player-agency only. Guard Bridge marks intent; it never auto-moves or auto-attacks.", fill="#ffffff")
...
preflight.save(root / "01_v0271_preflight_head_ci_resolution.png")

capture_paths = [root / "02_v0271_default_runtime_unchanged_visible.png"] + [
...
(root / "v0271-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.271 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
report.save(root / "45_v0271_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0271_preflight_head_ci_resolution.png"] + capture_paths + [root / "45_v0271_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "44_v0271_contact_sheet_visible.png")
