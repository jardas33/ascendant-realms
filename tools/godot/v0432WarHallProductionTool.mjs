...
async function validate() {
  ...
  if (branch !== branchName && !branch.startsWith('codex/v0433-') && !branch.startsWith('codex/v0434-') && branch !== 'codex/v0435-first-autonomous-easy-opponent-wave') failures.push(`branch ${branch}`);
