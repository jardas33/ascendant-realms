...
function validateBoundary(root) {
  ...
  const allowed = [
    ...
    // Later bounded Salto review checkpoints wrap the v0.215 launcher without
    // changing its production/default behavior; keep legacy validation reusable.
    /^tools\/godot\/captureGodotSaltoEnvironmentDressingWindows\.ps1$/u,
    /^tools\/godot\/validateGodotSaltoEnvironmentDressingWindows\.ps1$/u,
    /^tools\/godot\/runGodotSaltoEnvironmentDressingBenchmarkWindows\.ps1$/u,
    /^tools\/godot\/captureGodotSaltoCompositionLightingSelectionWindows\.ps1$/u,
    /^tools\/godot\/validateGodotSaltoCompositionLightingSelectionWindows\.ps1$/u,
    /^tools\/godot\/runGodotSaltoCompositionLightingSelectionBenchmarkWindows\.ps1$/u,
    ...
    /^docs\/V0221_BATTLEFIELD_COMPOSITION_REPORT\.md$/u,
    /^docs\/V0221_SELECTION_INDICATOR_REPORT\.md$/u,
    /^docs\/V0221_IMPLEMENTATION_REPORT\.md$/u,
    /^CHANGELOG\.md$/u,
