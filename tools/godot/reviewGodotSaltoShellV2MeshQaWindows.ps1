...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0197.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoShellV2MeshQaWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
