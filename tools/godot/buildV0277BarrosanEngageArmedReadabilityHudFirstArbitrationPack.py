...
draw.text((140, 145), "v0.277 PREFLIGHT - BARROSAN Engage Armed Readability + HUD-First Arbitration", fill="#e8d99d")
draw.text((140, 225), "Base HEAD:", fill="#9ecfc5")
draw.text((140, 275), "4671036f5733d5f16f9d79efa03eecc132a9f523", fill="#ffffff")
draw.text((140, 365), "Baseline exact-SHA Actions run:", fill="#9ecfc5")
draw.text((140, 415), "28583121386 - success", fill="#9fe2a3")
draw.text((140, 510), "Scope:", fill="#9ecfc5")
draw.text((140, 560), "Readability only. Engage Armed owns one concise world label; HUD/card carries Engagement contained, Bridge held, Pressure 90/100, No attack committed, No projectile, No damage.", fill="#ffffff")
...
preflight.save(root / "01_v0277_preflight_head_ci_resolution.png")

capture_paths = [root / "02_v0277_default_runtime_unchanged_visible.png"] + [
...
(root / "v0277-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.277 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
draw.text((100, 590), "Default runtime and opt-in v0.277 readability runtime were both inspected.", fill="#d7c98f")
report.save(root / "18_v0277_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0277_preflight_head_ci_resolution.png"] + capture_paths + [root / "18_v0277_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "17_v0277_contact_sheet_visible.png")
