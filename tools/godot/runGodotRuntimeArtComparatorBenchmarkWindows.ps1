...
$Arguments = @("--path", $GodotProjectPath, "--disable-vsync", "--max-fps", "0", "--resolution", "1600x900", "--", "--runtime-art-comparator", "--benchmark-sequence", "--capture-screenshots", "--artifact-root=$ArtifactArg")
...
if ($GodotExitCode -ne 0) {
  throw "Godot runtime-art comparator headed benchmark exited with code $GodotExitCode."
}
