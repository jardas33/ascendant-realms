...
draw.text((140, 145), "v0.266 PREFLIGHT - BARROSAN Watchpost Defender Readiness Bridge", fill="#e8d99d")
draw.text((140, 225), "Base HEAD / origin/main:", fill="#9ecfc5")
draw.text((140, 275), "5fd0c4b1163611280618efe7846e89373f4f8261", fill="#ffffff")
...
draw.text((140, 560), "Passive Watchpost Defender Readiness Bridge: online, outside-range, current, memory, and Barracks guidance.", fill="#ffffff")
...
preflight.save(root / "01_v0266_preflight_head_ci_resolution.png")
...
capture_paths = [root / "02_v0266_default_runtime_unchanged_visible.png"] + [
...
(root / "v0266-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.266 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
draw.text((100, 590), "Default runtime and opt-in Watchpost defender-readiness-bridge runtime were both inspected.", fill="#d7c98f")
report.save(root / "27_v0266_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0266_preflight_head_ci_resolution.png"] + capture_paths + [root / "27_v0266_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "26_v0266_contact_sheet_visible.png")
