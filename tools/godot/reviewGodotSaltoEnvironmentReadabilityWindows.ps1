...
$ReviewExe = Join-Path $RepoRoot "desktop-spikes\godot-salto\builds\AscendantRealmsGodotSalto-v0174.exe"
...
try {
  & (Join-Path $PSScriptRoot "launchGodotSaltoEnvironmentReadabilityWindows.ps1") -Wait:$Wait @RemainingArgs
} finally {
