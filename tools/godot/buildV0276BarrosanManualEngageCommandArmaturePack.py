...
draw.text((140, 145), "v0.276 PREFLIGHT - BARROSAN Manual Engage Command Armature", fill="#e8d99d")
draw.text((140, 225), "Base HEAD:", fill="#9ecfc5")
draw.text((140, 275), "65517b41d61b265a896136f08850e4ad735684cc", fill="#ffffff")
draw.text((140, 365), "Baseline exact-SHA Actions run:", fill="#9ecfc5")
draw.text((140, 415), "28555247901 - success", fill="#9fe2a3")
draw.text((140, 510), "Scope:", fill="#9ecfc5")
draw.text((140, 560), "Militia-only manual Engage eligibility and armed/cancelled readability. First click arms only. No damage, attack, projectile, pathing, AI, economy, fog, enemy HP/death/despawn, or default runtime mutation.", fill="#ffffff")
draw.text((140, 640), "Engage appears only after Field Barracks + Militia + Watchpost + Guard Bridge + Bridge Held / Engagement Contained after first contact resolved at 90/100.", fill="#d7c98f")
preflight.save(root / "01_v0276_preflight_head_ci_resolution.png")

capture_paths = [root / "02_v0276_default_runtime_unchanged_visible.png"] + [
...
(root / "v0276-black-frame-stats.json").write_text(json.dumps({"stats": all_stats}, indent=2) + "\n", encoding="utf-8")
...
draw.text((100, 105), "v0.276 BLACK-FRAME REJECTION REPORT", fill="#e8d99d")
...
draw.text((100, 590), "Default runtime and opt-in manual Engage runtime were both inspected.", fill="#d7c98f")
report.save(root / "29_v0276_black_frame_rejection_report_visible.png")

sheet_paths = [root / "01_v0276_preflight_head_ci_resolution.png"] + capture_paths + [root / "29_v0276_black_frame_rejection_report_visible.png"]
tiles = []
...
sheet.save(root / "28_v0276_contact_sheet_visible.png")
