...
const CHECKPOINT = "v0.17.5 Ranger near-base invisible blocker fix";
...
For the v0.17.5 Tutorial retest, start with V0175_EMMANUEL_7BAA99A_TUTORIAL_RETEST_INTAKE.md. The worker-economy direction remains documented in V017_WORKER_ECONOMY_DESIGN_SPEC.md; it is design-only and not implemented in this build.
