...
if (errors.length > 0) {
  ...
  console.log(
    [
      ...
      "modifiers, enemy doctrines, elite squads, battlefield events, tactical plans, enemy heroes, enemy pressure plans, maps, tutorial metadata, and visual asset metadata."
    ].join(" ")
  );
}
