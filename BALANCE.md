...
## Current First-Campaign Baseline - 2026-05-09 Enemy Strategic Pressure V1 Balance Gate
...
- Latest pressure-feel report: `docs/V071_ENEMY_PRESSURE_FEEL_REPORT.md` records the no-tuning decision, warning polish, status-priority guard, e2e hardening, telemetry clarity, and action-promotion gate. Future pressure changes should start from human play evidence, not from automatic escalation.
